...
public class CustomerRepositoryImpl  implements CustomerRepository {
    ...
    private static final String INSERT_CUSTOMER = " insert into customer (customer_name,customer_date_of_birth,customer_gender," +
    ...
    private static final String EDIT_CUSTOMER = "update customer set customer_name = ?,customer_date_of_birth = ?,customer_gender = ?" +
            ",customer_id_card = ?,customer_phone = ? ,customer_email = ?, customer_address = ? , customer_type_id = ? where customer_id = ? ; " ;
    private static final String DELETE_CUSTOMER = " delete from customer where customer_id = ? ; " ;
    private static final String FIND_CUSTOMER = " select  from customer where customer_name like ? or customer_email like " +
            "? or customer_address like ? or customer_type_id like ? ; " ;
    @Override
    ...
    @Override
    public List<Customer> findCustomer(String nameFind) {
        List<Customer> customers = new ArrayList<>() ;
        try {
            Connection connection = BaseRepository.getConnection() ;
